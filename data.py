...
# NOTE: load_obj and save_obj should be imported from webData.py

seasons = ['2021', '2020', '2019', '2018', '2017', '2016', '2015', '2014', '2013', '2012', '2011']
seasons.reverse()
    ...
    for s in range(len(seasons)):
        ...
        for game in sorted_games:
            ...
            for player in g['data']:
                if player['player'] is None or player['pts'] is None:
                    continue
