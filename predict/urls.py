...
urlpatterns = [
    ...
    path('history-arb/', views.arb_history, name='arb-history'),
    ...
    path('retrain-logs/<int:model>', views.retrainLogs, name='retrain-logs'),
    ...
    path('bets/<str:team>/<int:days>', views.betsList, name='bet-list-team'),
    ...
    path('date/<str:dateSelected>', GameListView.as_view(), name='home-predict-date'),
    path('all/', views.predictAll, name='predict-all'),
    path('all/<str:dateSelected>/<int:model>', views.predictAll, name='predict-all-model'),
    ...
    path('makedataset/<str:seasons>/<int:numgames>', views.makeDataSet, name='make-dataset-args'),
    path(
        'trainmodel/<str:model>/<int:epochs>/<int:batchSize>/'
        '<int:layer1Count>/<str:layer1Activation>/<int:layer2Count>/'
        '<str:layer2Activation>/<str:optimizer>/<str:es>/<str:rmw>/<str:kr>/'
        '<str:streaks>/<str:wl>/<str:gp>/<str:ps>/<str:players>/'
        '<str:ast>/<str:blk>/<str:reb>/<str:fg3>/<str:fg>/<str:ft>/'
        '<str:pf>/<str:pts>/<str:stl>/<str:turnover>/<str:re_eval>',
        views.trainModel, name='train-model',
    ),
